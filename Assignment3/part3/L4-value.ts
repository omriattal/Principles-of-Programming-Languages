...
export const makePromise = (val: CExp, env: Env): Promise => ({ tag: "Promise", val: val, env: env })
...
export type SExpValue = number | boolean | string | Closure | Promise | PrimOp | SymbolSExp | EmptySExp | CompoundSExp;
